...
record("planilha 19 linhas", ROWS.length === 19, `n=${ROWS.length}`);
record(
  "total pago planilha",
  Math.abs(somaValoresPlanilha() - 67909.43) < 0.01,
...
record("19 protocolos ok", ver.every((x) => x.ok) && ver.length === 19, JSON.stringify(ver.filter((x) => !x.ok)));
