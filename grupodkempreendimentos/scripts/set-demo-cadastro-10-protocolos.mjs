...
const PROTOCOLOS_ALVO = [
  ...
  { numeroContrato: "2026031701", cpf: "07795468497", placa: "UHQ8D58", nome: "BEIQUISSON PEREIRA ALVES", plano: "minha-moto", inicio: "17/03/2026" },
...
function buildDemo10Payload(demoBase) {
  ...
  demoPayload.dk_demo_cadastro_10_v1 = new Date().toISOString();
